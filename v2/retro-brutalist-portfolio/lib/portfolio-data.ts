...
export const resumeData = {
  ...
  skills: [
    ...
    { name: "PyTorch / Deep Learning", level: 92, bar: skillBar(92) },
    { name: "Computer Vision", level: 90, bar: skillBar(90) },
    { name: "LLMs / RAG / Agents", level: 88, bar: skillBar(88) },
    { name: "FastAPI / Backend", level: 85, bar: skillBar(85) },
    { name: "Next.js / TypeScript", level: 78, bar: skillBar(78) },
    { name: "Docker / AWS / DevOps", level: 75, bar: skillBar(75) },
    { name: "C/C++ / Systems", level: 70, bar: skillBar(70) },
  ],
}
