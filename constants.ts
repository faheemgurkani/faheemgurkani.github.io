...
export const PERSONAL_INFO = {
  ...
  social: {
    ...
    linkedinUrl: "https://www.linkedin.com/in/muhammad-faheem-367a1b279/",
    substack: "https://substack.com/@faheemgurkani",
    x: "https://x.com/faheemGurkani",
  },
};

/** Resume options: place PDFs in public/assets/; labels match CV titles (AI/ML, Backend, CV Engineer). */
export const RESUME_OPTIONS = [
  { label: "AI/ML Engineer", path: "/assets/Muhammad-Faheem-AI-ML-Engineer.pdf", filename: "Muhammad Faheem - AI-ML Engineer.pdf" },
  { label: "Backend Engineer", path: "/assets/Muhammad-Faheem-Backend-Engineer.pdf", filename: "Muhammad Faheem - Backend Engineer.pdf" },
  { label: "CV Engineer", path: "/assets/Muhammad-Faheem-CV-Engineer.pdf", filename: "Muhammad Faheem - CV Engineer.pdf" },
] as const;
...
export const CERTIFICATIONS: Certification[] = [
  { name: "Disaster Risk Monitoring Using Satellite Imagery", issuer: "NVIDIA", year: "2025" },
