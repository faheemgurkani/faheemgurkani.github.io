...
export const NoiseBackground = ({
  ...
  useAnimationFrame((time) => {
    ...
    if (time - lastDirectionChangeRef.current > 400 + Math.random() * 800) {
      velocityRef.current = generateRandomVelocityRef.current();
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "shadow-[0px_0.5px_1px_0px_rgba(0,0,0,0.1)_inset,0px_1px_0px_0px_rgba(255,255,255,0.05)]",
        "dark:shadow-[0px_1px_0px_0px_#0a0a0a_inset,0px_1px_0px_0px_rgba(38,38,38,0.8)]",
        backdropBlur &&
