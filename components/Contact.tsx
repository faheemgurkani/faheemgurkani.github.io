  ...
  return (
    <Section id="contact" title="Get In Touch">
      <div className="grid md:grid-cols-2 gap-12 items-end pt-8">
        ...
        <div className="space-y-8">
          <p className="text-neutral-400 text-lg leading-relaxed">
            I am currently open to research collaborations and engineering roles
            in AI, Machine Learning, and Backend development. Feel free to reach
            out directly or send a message using the form.
          </p>
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-4">
                <a
                  ...
                  className="flex items-center gap-3 text-neutral-300 hover:text-white transition-colors group flex-1 min-w-0"
                >
              ...
              <div className="flex flex-col gap-5 mt-2">
                <ResumeDropdown variant="contact" />
                <SocialLinksDropdown variant="contact" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-neutral-900/30 border border-neutral-800 p-8 rounded-sm">
          <form
            action="https://formsubmit.co/32703517175793864b061a2c1063759f"
            method="POST"
            className="space-y-4"
          >
            ...
            <div>
              <label
                htmlFor="name"
                className="block text-sm font-medium text-neutral-500 mb-2"
              >
                Name
              </label>
              <input
      ...
      <div className="flex flex-col md:flex-row justify-between items-center text-neutral-600 text-sm mt-20 font-mono">
        ...
        <p className="mt-2 md:mt-0 text-xs opacity-50">
